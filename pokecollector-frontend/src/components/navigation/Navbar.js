...
const NavbarComponent = ({ authed, setAuthed }) => {
    ...
    return (
        <div className="Navbar">
            <Navbar className="Navbar-section" expand="lg" collapseOnSelect sticky="top" >
            ...
            {cartOpen && <MyCart setCartOpen={setCartOpen} authed={authed} setOpenLogin={setOpenLogin} username={username} />}
        </div >
    )
};
